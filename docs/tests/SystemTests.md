...
Note that the tests must be run from the build directory, because they loof for images in the current working directory + `./ocre/src/ocre/var/lib/ocre/images/`.
