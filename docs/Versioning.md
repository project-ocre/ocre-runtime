...
Note the `version.h` file is not generated automatically. Instead it is maintained manually our automatically whenever we release a new version of the Ocre Runtime.
