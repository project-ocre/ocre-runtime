...
int sm_set_event_timer(state_machine_t *sm, int timer_id, k_timeout_t duration,
                       k_timeout_t period);
...
void sm_init(state_machine_t *sm, struct k_msgq *msgq, void *msg,
             void *custom_ctx, const struct smf_state *hsm);
