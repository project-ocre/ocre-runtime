...
{
    ctx->containers[container_id].ocre_runtime_arguments.stack_size = ctx->containers[container_id].ocre_container_data.stack_size;
    ctx->containers[container_id].ocre_runtime_arguments.heap_size = ctx->containers[container_id].ocre_container_data.heap_size;
    ...
    {
        ocre_healthcheck_init(&ctx->containers[container_id].ocre_container_data.WDT, ctx->containers[container_id].ocre_container_data.watchdog_interval);
    }
...
ocre_container_status_t CS_stop_container(ocre_cs_ctx *ctx, int container_id,
...
ocre_container_status_t CS_destroy_container(ocre_cs_ctx *ctx, int container_id,
                                             ocre_container_runtime_cb callback)
{
    if (container_id < 0 || container_id >= MAX_CONTAINERS)
    {
...
ocre_container_status_t CS_restart_container(ocre_cs_ctx *ctx, int container_id,
                                             ocre_container_runtime_cb callback)
{
    if (container_id < 0 || container_id >= MAX_CONTAINERS)
    {
